...
NUM_CLIENTS: int = int(os.environ.get("NUM_CLIENTS", 3))
HOST: str = os.environ.get("HOST", "0.0.0.0")
PORT: int = int(os.environ.get("PORT", 8080))
PRESHARED_SECRET: str = os.environ.get(
    "PRESHARED_SECRET", "my_secure_presHared_secret_123!"
)
WEIGHT_TTL: int = int(os.environ.get("WEIGHT_TTL", 600))  # seconds
...
aggregated_state_dict_lock: asyncio.Lock = asyncio.Lock()
...
HASHED_PRESHARED_SECRET: bytes = bcrypt.hashpw(sha256_hash, bcrypt.gensalt())
